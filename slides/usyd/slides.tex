...
\begin{frame}{Solution Pipeline \& Contributions}
  ...
  \begin{itemize}
    ...
    We prove that the client-wise total loss is unimodal with respect to the horizon length and identify the smallest sufficient horizon as its global minimizer. 
